...
observed_metadata_file <- file.path(workspace, "SLiM/input/climate_anomaly_metadata_from_grib.csv")

trend_matrix_file <- file.path(workspace, "SLiM/input/climate_anomaly_matrix_trend2050_from_grib.csv")
trend_years_file <- file.path(workspace, "SLiM/input/climate_years_trend2050_from_grib.csv")
trend_metadata_file <- file.path(workspace, "SLiM/input/climate_anomaly_trend2050_metadata_from_grib.csv")
trend_summary_file <- file.path(workspace, "SLiM/input/climate_anomaly_trend2050_summary_from_grib.csv")
...
if (!file.exists(observed_metadata_file))
	stop("Observed anomaly metadata not found. Run 3_gribClimateAnomaly.R first.")
