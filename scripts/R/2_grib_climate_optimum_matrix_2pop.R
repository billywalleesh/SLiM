...
slim_climate_file <- file.path(input_directory, "climate_matrix/grib_climate_optimum_matrix_2pop.csv")
metadata_file <- file.path(input_directory, "metadata/grib_climate_optimum_matrix_2pop_metadata.csv")
