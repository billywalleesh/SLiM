...
anomaly_matrix_file <- file.path(workspace, "SLiM/input/climate_anomaly_matrix_from_grib.csv")
climate_years_file <- file.path(workspace, "SLiM/input/climate_years_from_grib.csv")
metadata_file <- file.path(workspace, "SLiM/input/climate_anomaly_metadata_from_grib.csv")
baseline_file <- file.path(workspace, "SLiM/input/climate_baseline_by_pop_from_grib.csv")
...
if (!all(required_columns %in% names(population_locations)))
	stop("population_locations_from_grib.csv needs columns: pop, lon, lat")
...
print(head(metadata))
message("Wrote anomaly matrix to: ", anomaly_matrix_file)
