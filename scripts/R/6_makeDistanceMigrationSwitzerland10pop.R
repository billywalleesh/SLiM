...
populationFile <- file.path(workspace, "SLiM/input/population_locations_switzerland_10pop.csv")
migrationFile <- file.path(workspace, "SLiM/input/migration_matrix_switzerland_10pop_distance.csv")
migrationDetailsFile <- file.path(workspace, "SLiM/input/migration_matrix_switzerland_10pop_distance_details.csv")
migrationSummaryFile <- file.path(workspace, "SLiM/input/migration_matrix_switzerland_10pop_distance_summary.csv")
